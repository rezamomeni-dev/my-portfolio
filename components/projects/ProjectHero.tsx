      ...
      <SectionContainer>
         ...
         <div className="grid lg:grid-cols-2 gap-12 items-center mb-16">
            ...
            <motion.div
               ...
               className="relative"
            >
               <div className="relative rounded-3xl overflow-hidden border border-zinc-200 dark:border-zinc-800 shadow-2xl bg-zinc-100 dark:bg-zinc-900">
                  {/* Browser UI Mockup */}
                  <div className=" top-0 left-0 right-0 h-8 bg-zinc-200/50 dark:bg-zinc-800/50 backdrop-blur-md border-b border-zinc-300 dark:border-zinc-700 flex items-center px-4 gap-1.5 z-10">
