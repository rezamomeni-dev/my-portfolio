...
const getIcon = (label: string) => {
   ...
   if (l.includes("frontend") || l.includes("ui") || l.includes("framework"))
      return <Layout className="w-5 h-5" />;
   if (l.includes("backend") || l.includes("api") || l.includes("server"))
      return <Server className="w-5 h-5" />;
   if (l.includes("database") || l.includes("db") || l.includes("storage"))
      return <Database className="w-5 h-5" />;
   if (l.includes("security") || l.includes("auth") || l.includes("encryption"))
         ...
         <SectionContainer>
            <div className="flex flex-col mb-16">
               ...
               <p className="text-zinc-600 dark:text-zinc-400 text-lg">
                  The underlying technologies and systems that power the
                  platform.
               </p>
            </div>
