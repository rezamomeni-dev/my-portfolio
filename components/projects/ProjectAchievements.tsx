...
const getIcon = (title: string) => {
  ...
  if (t.includes("email") || t.includes("mail")) return <Mail className="w-6 h-6" />;
  if (t.includes("turnaround") || t.includes("time") || t.includes("faster")) return <Timer className="w-6 h-6" />;
  if (t.includes("user") || t.includes("adoption") || t.includes("growth")) return <Users className="w-6 h-6" />;
  if (t.includes("growth") || t.includes("scale")) return <TrendingUp className="w-6 h-6" />;
  if (t.includes("performance") || t.includes("boost") || t.includes("fast")) return <Zap className="w-6 h-6" />;
  if (t.includes("transaction") || t.includes("volume") || t.includes("money") || t.includes("$")) return <DollarSign className="w-6 h-6" />;
      ...
      <SectionContainer>
        <div className="flex flex-col mb-16">
          <div className="flex items-center gap-3 mb-4">
             ...
             <h2 className="text-3xl font-bold text-zinc-900 dark:text-white">Key Achievements</h2>
          </div>
