        ...
        <div className="flex flex-col sm:flex-row justify-between gap-12">
          {prevProject ? (
            <motion.div
              ...
              className="group"
            >
              <Link href={`/projects/${prevProject.slug}`} className="flex flex-col items-start gap-4">
          ...
          {nextProject ? (
            ...
            >
              <Link href={`/projects/${nextProject.slug}`} className="flex flex-col items-end gap-4">
                <span className="flex items-center gap-2 text-zinc-500 dark:text-zinc-500 font-bold uppercase tracking-widest text-xs group-hover:text-primary transition-colors">
                  Next Project
