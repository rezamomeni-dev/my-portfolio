        ...
        <div className="text-left">
          ...
          >
            ...
            <div className="flex items-center gap-5">
              <a href={github} target="_blank" rel="noopener noreferrer" className="text-zinc-400 hover:text-primary transition-colors">
                <Github className="w-6 h-6" />
              </a>
              <a href={linkedin} target="_blank" rel="noopener noreferrer" className="text-zinc-400 hover:text-primary transition-colors">
                <Linkedin className="w-6 h-6" />
              </a>
              <a href={twitter} target="_blank" rel="noopener noreferrer" className="text-zinc-400 hover:text-primary transition-colors">
        ...
        >
          <div className="relative w-72 h-72 md:w-96 md:h-96">
            ...
            >
              ...
              <div className="font-bold text-indigo-500">Architecture</div>
            </motion.div>
          </div>
        </motion.div>
      </div>
