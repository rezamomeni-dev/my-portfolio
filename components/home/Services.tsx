...
import { Code, Layout, Zap, Users, ArrowUpRight, LucideIcon } from "lucide-react";
...
const stylesMap: Record<string, { bg: string, text: string }> = {
  ...
  "Performance Optimization": { bg: "bg-amber-500/10", text: "text-amber-500" },
  "Technical Leadership": { bg: "bg-emerald-500/10", text: "text-emerald-500" },
};
      ...
      <div className="max-w-5xl mx-auto px-6">
        ...
        <div className="grid md:grid-cols-2 gap-8">
          {services.items.map((service, index) => {
            ...
            const styles = stylesMap[service.title] || { bg: "bg-primary/10", text: "text-primary" };
            ...
            return (
              ...
              >
                <div className={`w-14 h-14 ${styles.bg} rounded-2xl flex items-center justify-center mb-6 group-hover:scale-110 transition-transform`}>
