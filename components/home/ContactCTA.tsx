                        ...
                        >
                           <div className="grid sm:grid-cols-2 gap-4">
                              <div className="space-y-2">
                                 ...
                                 <input
                                    required
                                    type="text"
                                    className="w-full px-4 py-3 rounded-xl bg-zinc-100 border-transparent focus:bg-white focus:border-primary focus:ring-0 transition-all text-zinc-900"
                           ...
                           <div className="space-y-2">
                              ...
                              <textarea
                                 required
                                 rows={4}
                                 className="w-full px-4 py-3 rounded-xl bg-zinc-100 border-transparent focus:bg-white focus:border-primary focus:ring-0 transition-all text-zinc-900 resize-none"
                           ...
                           >
                              {isSubmitting ? "Sending..." : contactCTA.cta}{" "}
